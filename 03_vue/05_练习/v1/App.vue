 ...
 * @LastEditTime: 2023-05-30 16:42:03
      ...
      <div v-show="current === 0">
        ...
        <div class="tab-list">
          ...
          <div class="tab-item">
            ...
            <div class="desc">
              <span class="name">内马尔·达席尔瓦·儒尼奥尔</span>
              <div class="hot-bar">
                <div class="inner hot3">274762热度</div>
              </div>
            </div>
          </div>
          ...
          <div class="tab-item">
            ...
            <div class="desc">
              <span class="name">克里斯蒂亚诺·罗纳尔多</span>
              <div class="hot-bar">
                <div class="inner hot2">273060热度</div>
              </div>
            </div>
          </div> -->
        </div>
